...
function createServer(options) {
    var bunyan = require('./bunyan_helper');
    var InternalError = require('./errors/index').InternalError;
...
module.exports = {
    ...
    get HttpClient() {
        return (require('./clients/index').HttpClient);
    },
    get JsonClient() {
        return (require('./clients/index').JsonClient);
    },
    get StringClient() {
        return (require('./clients/index').StringClient);
    },
...
if (!process.env.RESTIFY_CLIENT_ONLY) {
    ...
    module.exports.formatters = require('./formatters/index');
